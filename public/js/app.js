...
"use strict";
var SCOPE = 'https://www.googleapis.com/auth/youtube https://www.googleapis.com/auth/youtube.force-ssl https://www.googleapis.com/auth/youtube.readonly https://www.googleapis.com/auth/youtubepartner';
var status = false;
var GoogleAuth = {};

var o = {
    initCallback: function initCallback(status) {},
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__google_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youtube_channel_js__ = __webpack_require__(33);
...
window.app = new Vue({
    el: '#app',
    data: {
        userStatus: __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].isSignedIn(),
        subscriptions: {},
        allVideos: [],
        page: 1
    },
    computed: {
        ...
        pageVideos: function pageVideos() {
            return this.videos.slice((this.page - 1) * VIDEOS_PER_PAGE, this.page * VIDEOS_PER_PAGE);
        }
    },
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].initCallback = function (status) {
    ...
    methods: {
        handleAuthClick: function handleAuthClick() {
            if (this.userStatus) {
                __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].signOut();
            } else {
                __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].signIn();
            }
            this.userStatus = __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].isSignedIn();
        },
        loadData: function loadData() {
            this.loadYoutubeChannels();
        },
        loadYoutubeChannels: function loadYoutubeChannels(pageToken) {
            var client = __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].getClient();
            ...
            client.youtube.subscriptions.list({ part: 'snippet', mine: true, pageToken: pageToken, maxResults: 50 }).then(function (resp) {
                resp.result.items.forEach(function (channel) {
                    ...
                    app.$set(app.subscriptions, channelId, new __WEBPACK_IMPORTED_MODULE_1__youtube_channel_js__["a" /* default */](channel, function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__google_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__channel_js__ = __webpack_require__(32);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var YoutubeChannel = function (_Channel) {
    _inherits(YoutubeChannel, _Channel);

    function YoutubeChannel(channel, callback) {
        _classCallCheck(this, YoutubeChannel);

        var _this = _possibleConstructorReturn(this, (YoutubeChannel.__proto__ || Object.getPrototypeOf(YoutubeChannel)).call(this));
    ...
    _createClass(YoutubeChannel, [{
        ...
        key: 'nextPage',
        value: function nextPage(callback) {
            var client = __WEBPACK_IMPORTED_MODULE_0__google_js__["a" /* default */].getClient();
...
}(__WEBPACK_IMPORTED_MODULE_1__channel_js__["a" /* Channel */]);

/* harmony default export */ __webpack_exports__["a"] = (YoutubeChannel);

var YoutubeVideo = function (_Video) {
    _inherits(YoutubeVideo, _Video);

    function YoutubeVideo(video) {
        _classCallCheck(this, YoutubeVideo);

        var _this2 = _possibleConstructorReturn(this, (YoutubeVideo.__proto__ || Object.getPrototypeOf(YoutubeVideo)).call(this));
    ...
    return YoutubeVideo;
}(__WEBPACK_IMPORTED_MODULE_1__channel_js__["b" /* Video */]);
...
Component.options.__file = "/var/www/ktube.yt/dev/resources/assets/js/components/Example.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-10b733bd", Component.options)
  } else {
    hotAPI.reload("data-v-10b733bd", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-10b733bd", module.exports)
  }
}
